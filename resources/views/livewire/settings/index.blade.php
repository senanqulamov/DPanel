        ...
        <div class="lg:col-span-3">
            <x-card>
                ...
                <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Show detailed error messages') }}</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if($activeTab === 'sap')
                        <div>
                            <h3 class="text-xl font-semibold mb-4">{{ __('SAP Integration Settings') }}</h3>
                            <form wire:submit="saveSap" class="space-y-4">
                                <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg mb-4">
                                    ...
                                    <div>
                                        <p class="font-medium text-sm">{{ __('Enable SAP Integration') }}</p>
                                        <p class="text-xs text-slate-500">{{ __('Connect to SAP ERP system') }}</p>
                                    </div>
                                </div>
                                @if($sap_enabled)
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <x-input label="{{ __('SAP Username') }}" wire:model="sap_username"/>
                                        <x-password label="{{ __('SAP Password') }}" wire:model="sap_password"/>
                                        <x-select.styled
                                            label="{{ __('Language') }}"
                                        ...
                                        <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-slate-500">{{ __('Automatically sync data') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @else
                                    <x-alert color="blue" icon="information-circle">
                                        {{ __('Enable SAP integration to configure connection settings') }}
                                    </x-alert>
                                @endif
                            </form>
                        </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-slate-500">{{ __('Improve performance') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Redirect to HTTPS') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Enable CSRF tokens') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('In passwords') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Allow API access') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Authentication required') }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Notify on new RFQ') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Notify on quote') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Notify on order') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Notify on SLA issues') }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Send via email') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Send via SMS') }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Send to Slack') }}</p>
                                        </div>
                                    </div>
                                </div>
                                @if($notify_via_slack)
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('For high-value orders') }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">{{ __('Virus scanning') }}</p>
                                        </div>
                                    </div>
                                </div>
