<div>
                    ...
                    <div class="flex-1">
                        ...
                        @if($stat['change'] != 0)
                            <p class="mt-2 flex items-center text-sm {{ $stat['change'] > 0 ? 'text-white' : 'text-white/70' }}">
                                ...
                                <span class="ml-1">{{__('vs last period')}}</span>
                            </p>
                        @endif
                    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-8">
        ...
        <div class="lg:col-span-2">
            <x-card class="h-full">
                <x-slot name="header">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold mr-2 text-slate-200">{{ __('Sales Overview') }}</h3>
                ...
                <div class="relative h-80 text-slate-200 bg-slate-100 dark:bg-slate-800 rounded-lg p-4">
            ...
            <x-card class="h-full">
                <x-slot name="header">
                    <x-badge color="primary" dark>
                        ...
                        <h3 class="text-lg font-semibold ">{{__('Orders Status')}}</h3>
                    </x-badge>
                </x-slot>
                <div class="relative h-80 flex items-center justify-center bg-slate-100 dark:bg-slate-800 rounded-lg p-4">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-8">
        ...
        <div class="lg:col-span-2">
            <x-card class="h-full">
                <x-slot name="header">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold mr-2 text-slate-200">{{__('User Activity')}}</h3>
                        <x-badge color="primary" dark>
                            <svg class="w-3 h-3 mr-1.5 animate-pulse" fill="currentColor" viewBox="0 0 8 8">
                                <circle cx="4" cy="4" r="3"/>
                            </svg>
                ...
                <div class="relative h-64 bg-slate-100 dark:bg-slate-800 rounded-lg p-4">
        ...
        <div>
            <x-card class="h-full">
                <x-slot name="header">
                    <h3 class="text-lg font-semibold text-slate-200">{{__('System Health')}}</h3>
                </x-slot>
                <div class="space-y-6">
                    <!-- Health Score -->
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <x-card>
            <x-slot name="header">
                <h3 class="text-lg font-semibold text-slate-200">{{__('Top Products')}}</h3>
            </x-slot>
            <div class="space-y-4">
        ...
        <x-card>
            <x-slot name="header">
                <h3 class="text-lg font-semibold text-slate-200">{{__('Recent Orders')}}</h3>
            </x-slot>
            <div class="space-y-3">
    ...
    <div class="mt-8">
        <x-card>
            <x-slot name="header">
                <h3 class="text-lg font-semibold text-slate-200">{{ __('Recent Activity') }}</h3>
            </x-slot>
            <div class="space-y-3">
    ...
    @push('scripts')
        ...
        <script>
            ...
            const textColor = isDark
                ? 'rgba(255, 255, 255, 0.7)' // dark mode text
