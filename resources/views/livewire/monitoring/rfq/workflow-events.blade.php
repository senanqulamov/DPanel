                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        class="w-full pl-10 pr-4 py-2.5 text-sm rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                                    >
                                    ...
                                    @if($filterUser)
                                        <button
                                            wire:click="$set('filterUser', null)"
                            ...
                            <div class="space-y-2">
                                ...
                                <input
                                    ...
                                    class="w-full px-4 py-2.5 text-sm rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                                >
                            </div>
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @foreach($filterEventTypes as $eventType)
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                                    ...
                                    @endforeach
                                    @if($filterUser)
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium bg-purple-50 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300 border border-purple-200 dark:border-purple-800">
                                    ...
                                    @if($filterDateFrom || $filterDateTo)
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium bg-green-50 text-green-700 dark:bg-green-900/30 dark:text-green-300 border border-green-200 dark:border-green-800">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                            @if($filterDateFrom && $filterDateTo)
                        ...
                        @foreach($this->workflowEvents as $event)
                            <div class="relative flex gap-4" wire:key="event-{{ $event->id }}">
                                ...
                                <div class="relative flex-shrink-0">
                                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-{{ $this->getEventColor($event->event_type) }}-100 dark:bg-{{ $this->getEventColor($event->event_type) }}-900/30 border-2 border-{{ $this->getEventColor($event->event_type) }}-500 dark:border-{{ $this->getEventColor($event->event_type) }}-400">
                                        <svg class="w-6 h-6 text-{{ $this->getEventColor($event->event_type) }}-600 dark:text-{{ $this->getEventColor($event->event_type) }}-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm hover:shadow-md transition-shadow">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if($event->user)
                                                    <span class="text-xs text-gray-600 dark:text-gray-400">
                                                        {{ __('by') }} <span class="font-medium text-gray-900 dark:text-gray-100">{{ $event->user->name }}</span>
                                                    </span>
                                                @endif
                                            </div>
                                        ...
                                        @if($event->metadata && count($event->metadata) > 0)
                                            <div class="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                                                <details class="group">
                                                    <summary class="text-xs font-medium text-gray-600 dark:text-gray-400 cursor-pointer hover:text-gray-900 dark:hover:text-gray-200 flex items-center gap-1">
